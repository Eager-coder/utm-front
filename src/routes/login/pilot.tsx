...
export const Route = createFileRoute('/login/pilot')({
  component: RouteComponent,
})

type LoginParams = { email: string; password: string }

async function loginPilot({ email, password }: LoginParams) {
  const res = await fetch('/api/login/pilot', {
    method: 'POST',
